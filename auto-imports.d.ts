...
declare global {
  ...
  const useBufferQueue: typeof import('./src/hooks/buffer-queue')['useBufferQueue']
  ...
  const useQps: typeof import('./src/hooks/qps')['useQps']
  const useRef: typeof import('vue-jsx-vapor')['useRef']
  const useRenderQueue: typeof import('./src/hooks/render-queue')['useRenderQueue']
